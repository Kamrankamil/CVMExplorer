...
import {  FaTwitter,FaFacebook,FaReddit,FaMedium,FaHome,FaCompass,FaStar ,FaSlidersH ,FaGithub    } from 'react-icons/fa';
...
import logoImage from './CVM-Logo.png';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold">
    Explorer
      ...
      <Link href="https://www.facebook.com/people/CosVM/100094733726910/?mibextid=O4c6Bo" isExternal>
